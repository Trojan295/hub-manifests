...
This directory contains source Terraform module, which is used in the `cap.implementation.aws.elasticsearch.install:0.1.0` Implementation manifest.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_main"></a> [main](#module\_main) | git::https://github.com/lgallard/terraform-aws-elasticsearch.git | 0.9.0 |
...
| <a name="input_create_service_link_role"></a> [create\_service\_link\_role](#input\_create\_service\_link\_role) | Create service link role for AWS Elasticsearch Service | `bool` | `false` | no |
...
| <a name="input_elasticsearch_version"></a> [elasticsearch\_version](#input\_elasticsearch\_version) | The version of Elasticsearch to deploy. | `string` | `"7.10"` | no |
...
| <a name="output_domain_name"></a> [domain\_name](#output\_domain\_name) | Unique identifier for the domain |
| <a name="output_elasticsearch_version"></a> [elasticsearch\_version](#output\_elasticsearch\_version) | Version of the Elasticsearch domain |
...
1. Set environmental variables:
   ...
   export MANIFEST_PATH="terraform.aws.elasticsearch.provision"
